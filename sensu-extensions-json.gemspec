...
Gem::Specification.new do |spec|
  spec.name          = "sensu-extensions-json"
  spec.version       = "0.0.1"
  spec.authors       = ["Sensu-Extensions and contributors"]
  spec.email         = ["<sensu-users@googlegroups.com>"]

  spec.summary       = "The Sensu Core built-in json mutator"
  spec.description   = "The Sensu Core built-in json mutator"
  spec.homepage      = "https://github.com/sensu-extensions/sensu-extensions-json"
